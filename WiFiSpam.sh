...
echo -e "   My GitHub:$BOLD_WHITE hhttps://github.com/Aghorii001/-WiFi-Spam-v1-Aghorii.git"
exit
}

function title() {
echo -e "$BOLD_GREEN    _       ___ _______    _____                     "
echo "   |R |     / (_) ____(_)  / ___/____  ____ _____ ___ "
echo "   | A| /| / / / /_  / /   \\__ \\/ __ \\/ __ \`/ __ \`__ \\"
echo "   | V|/ |/ / / __/ / /   ___/ / /_/ / /_/ / / / / / /"
echo "   |_I_/|__/_/_/   /_/   /____/ .___/\\__,_/_/ /_/ /_/"
echo "                            /_/                      "
echo -e "$BOLD_WHITE                                           By Aghorii "
echo " "
}
